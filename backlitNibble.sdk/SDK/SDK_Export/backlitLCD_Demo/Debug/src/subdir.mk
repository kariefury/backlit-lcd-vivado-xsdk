...
src/%.o: ../src/%.c
	...
	mb-gcc -Wall -O0 -g3 -c -fmessage-length=0 -I../../backlitLCD_Demo_bsp/microblaze_0/include -mlittle-endian -mcpu=v9.3 -mxl-soft-mul -Wl,--no-relax -ffunction-sections -fdata-sections -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
